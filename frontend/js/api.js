...
function statusBadge(s) {
  const m = { Pending: ['bg-amber-100 text-amber-700', 'Pendiente'],
...
function kycBadge(s) {
  const m = { NotStarted: ['bg-gray-100 text-gray-600', 'Sin verificar'],
...
function renderNav() {
  ...
  if (u) {
    el.innerHTML = `
      ...
      <a href="dashboard.html" class="text-sm text-gray-600 hover:text-rose-500 hidden sm:inline">📊 Panel</a>
